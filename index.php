<?php
        ...
        if (!file_exists($dir)){ 
            ...
            if ($tamanio < ($tamano*1024)){
                if (move_uploaded_file($_FILES['foto']['tmp_name'],$ruta_carga)){
                    $sql = "INSERT INTO gifs (id,name, descripcion, opcion, path) VALUES ('','$name','$description','$opcion','$ruta_carga')";
    ...
    elseif (isset($_POST['traducir'])){
        $frase = $_POST['frase'];
        $sql = "SELECT * FROM gifs WHERE name = '$frase'";
        $result = mysqli_query($conectar, $sql);
        if (mysqli_num_rows($result) > 0) {
            $update_expresion = 2;
            $row = mysqli_fetch_array($result);
...
<ul id="slide-left" class="sidenav purple darken-4" style="transform: translateX(0px);">
    ...
    <li class="deep-purple lighten-2">
        <a style="color:#e8eaf6 ;font-size:20px;" href="./index.html" class="modal-trigger"><i class="material-icons deep-purple-text text-lighten-5 small">home</i>Home</a></li>
    <li class="deep-purple lighten-2">
        <a style="color:#e8eaf6 ;font-size:20px;" href="#modal1" class="modal-trigger"><i class="material-icons deep-purple-text text-lighten-5 small">add_circle_outline</i>Add Gif</a></li>
    <?php if ($update_expresion == 0 ) {?>
        <li class="deep-purple lighten-2">
            <a style="color:#e8eaf6 ;font-size:20px;" href="#modal2" class="modal-trigger"><i class="material-icons deep-purple-text text-lighten-5 small">upgrade</i>Update Gif</a></li>
    <?php } elseif ($update_expresion == 1){?>
        <li class="deep-purple lighten-4">
        <a style="font-size:20px;" href="#modal2" class="modal-trigger purple-text text-lighten-1 small"><i class="material-icons purple-text text-lighten-1 small">upgrade</i>Ready to Update</a></li>
    <?php }?>
    <li class="deep-purple lighten-2">
        <a style="color:#e8eaf6 ;font-size:20px;" href="#modal3" class="modal-trigger"><i class="material-icons deep-purple-text text-lighten-5 small">list</i>Lists of expresions</a></li>
    <li class="deep-purple lighten-2">
        <a style="color:#e8eaf6 ;font-size:20px;" href="#modal4" class="modal-trigger"><i class="material-icons deep-purple-text text-lighten-5 small">account_tree</i>Database</a></li>
</ul>
  ...
  <div id="modal1" class="modal ">
    ...
    <div class="row">
        <form action="./index.php" method="post" enctype="multipart/form-data">
            <div class="input-field col s12 l12 m12">
                ...
                <input id="icon" type="text" class="validate" name="word">
    ...
    <div id="modal2" class="modal">
        ...
        <div class="row">
            <form action="./index.php?id=<?php echo $row['id'];?>" method="post" enctype="multipart/form-data">
                <div class="input-field col s12 l12 m12">
                    <i class="material-icons prefix">translate</i>
                    <input id="icon" type="text" class="validate" name="word" value="<?php echo $row['name'] ?>">
                    <label for="icon">Word</label>
                </div>
                <div class="input-field col s12 l12 m12">
                    <i class="material-icons prefix">description</i>
    ...
    <div id="modal3" class="modal">
        ...
        <h4 style="color:#e8eaf6 ;">TIMER CONFIGURATION</h4>
        </div>
        <div class="row">
        <div class="row">
        ...
        <table class="highlight centered responsive-table">
            ...
            ?>   
                <tr>
                    ...
                    <td><img src="<?php echo $row['path']?>" alt="" width="50px"></td>
                </tr>
                <?php }?>
            </tbody>
        </table>
  ...
  <div id="modal4" class="modal ">
    ...
    <div class="row">
        <form action="./index.php" method="post">
            ...
            <div class="input-field col s12 l12 m12">
                <i class="material-icons prefix">account_tree</i>
                <input id="icon" type="text" class="validate" name="newdb">
                <label for="icon">New Database</label>
            </div>
            
            <div class="col s12 m12 l12 center">
                <button class="btn waves-effect waves-light purple darken-4 btn-large pulse" type="submit" name="update_db">Update
                    <i class="material-icons small right indigo-text text-lighten-5">save</i>
                </button>
            </div>   
        </form>
            ...
            <div class="col s12 m12 l6">
                <?php if ($update_expresion == 2) {
                    ...
                    <div class="card">
                        ...
                        <p style="font-size: 25px;" class="deep-purple-text"><?php echo $row['name'] ?></p>
                        </div>
                    </div>
                <?php } ?>    
            </div>
